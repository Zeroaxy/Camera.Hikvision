...
namespace PreviewDemo
{
    partial class Login
    {
        ...
        {
            #region 数据记忆
            Settings.Default.port1 = textBox1.Text;
            Settings.Default.port2 = textBox2.Text;
            Settings.Default.port3 = textBox3.Text;
            Settings.Default.port4 = textBox4.Text;
            Settings.Default.port5 = textBox5.Text;
            Settings.Default.port6 = textBox6.Text;
            Settings.Default.port7 = textBox7.Text;
            Settings.Default.port8 = textBox8.Text;
            Settings.Default.port9 = textBox9.Text;
            Settings.Default.ip = textBoxport.Text;
            Settings.Default.name = textBoxUserName.Text;
